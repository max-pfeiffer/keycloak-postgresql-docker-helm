...
*/}}
{{- define "keycloak-postgresql.chart" -}}
...
helm.sh/chart: {{ include "keycloak-postgresql.chart" . }}
...
*/}}
{{- define "keycloak-postgresql.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "keycloak-postgresql.fullname" .) .Values.serviceAccount.name }}
{{- else }}
